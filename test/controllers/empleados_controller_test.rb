...
class EmpleadosControllerTest < ActionController::TestCase
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post :create, empleado: { Apellido: @empleado.Apellido, Diploma: @empleado.Diploma, Edad: @empleado.Edad, fecha: @empleado.fecha }
    end
  ...
  test "should update empleado" do
    patch :update, id: @empleado, empleado: { Apellido: @empleado.Apellido, Diploma: @empleado.Diploma, Edad: @empleado.Edad, fecha: @empleado.fecha }
    assert_redirected_to empleado_path(assigns(:empleado))
  end
