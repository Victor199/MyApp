...
class ArchivosControllerTest < ActionController::TestCase
  ...
  test "should create archivo" do
    assert_difference('Archivo.count') do
      post :create, archivo: { adiciones: @archivo.adiciones, misarchivos: @archivo.misarchivos, reservas: @archivo.reservas }
    end
  ...
  test "should update archivo" do
    patch :update, id: @archivo, archivo: { adiciones: @archivo.adiciones, misarchivos: @archivo.misarchivos, reservas: @archivo.reservas }
    assert_redirected_to archivo_path(assigns(:archivo))
  end
