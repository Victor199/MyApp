...
class TiendasControllerTest < ActionController::TestCase
  ...
  test "should create tienda" do
    assert_difference('Tienda.count') do
      post :create, tienda: { articulo: @tienda.articulo, direccion: @tienda.direccion, sucursales: @tienda.sucursales }
    end
  ...
  test "should update tienda" do
    patch :update, id: @tienda, tienda: { articulo: @tienda.articulo, direccion: @tienda.direccion, sucursales: @tienda.sucursales }
    assert_redirected_to tienda_path(assigns(:tienda))
  end
