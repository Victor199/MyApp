...
class ContactosControllerTest < ActionController::TestCase
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post :create, contacto: { edad: @contacto.edad, estudia: @contacto.estudia, nacimiento: @contacto.nacimiento, nombre: @contacto.nombre }
    end
  ...
  test "should update contacto" do
    patch :update, id: @contacto, contacto: { edad: @contacto.edad, estudia: @contacto.estudia, nacimiento: @contacto.nacimiento, nombre: @contacto.nombre }
    assert_redirected_to contacto_path(assigns(:contacto))
  end
